...
"[project]/my-bio-history/src/components/contact/contact.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Contact = ()=>{
    ...
    const handleSubmit = (e)=>{
        ...
        alert("Messaggio inviato da ".concat(formData.name, " (").concat(formData.email, ")"));
    };
...
//# sourceMappingURL=my-bio-history_src_components_contact_contact_tsx_bfef03a7._.js.map